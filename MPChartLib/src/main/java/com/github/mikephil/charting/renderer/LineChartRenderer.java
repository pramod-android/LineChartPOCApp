    ...
    protected void drawLinear(Canvas c, ILineDataSet dataSet) {
        ...
        if (dataSet.getColors().size() > 1) {
            ...
            if (e1 != null) {
                ...
                int j = 0;
                for (int x = mXBounds.min; x <= entryCount -1; x++) {
                    ...
                    Log.i("mLineBuffer"," max "+mXBounds.max + " min "+mXBounds.min + " phaseY "+phaseY+ " e1.getX() "+e1.getX() +" e1.getY() "+e1.getY() + " e2.getX() "+e2.getX() +" e2.getY() "+e2.getY()+" mLineBuffer "+mLineBuffer[j]);
